...
//    String station_service_url;
    ...
    @Override
    public Response checkSecurityAboutOrder(ErrorSceneFlag errorSceneFlag, Date dateFrom, String accountId, HttpHeaders headers) {
        ...
        ErrorUtil.errorScene(errorSceneFlag, ServiceKey.TS_ORDER_OTHER_SERVICE);
