...
public class SecurityServiceImpl implements SecurityService {
    ...
    @Override
    public Response check(ErrorSceneFlag errorSceneFlag, String accountId, HttpHeaders headers) {
        ...
        OrderSecurity orderOtherResult = getSecurityOrderOtherInfoFromOrder(errorSceneFlag, new Date(), accountId, headers);
        ...
        //自定义故障场景
        ErrorUtil.errorScene(errorSceneFlag, ServiceKey.TS_SECURITY_SERVICE);
    ...
    private OrderSecurity getSecurityOrderOtherInfoFromOrder(ErrorSceneFlag errorSceneFlag, Date checkDate, String accountId, HttpHeaders headers) {
